...
<link href="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.css" rel="stylesheet">
  ...
  <div class="row" id="app">
    <div class="col-lg-12">
        {!! Form::open(array('route' => array('frontend.slsmark.storesc'), 'method' => 'POST', 'files'=> true, 'id'=>'form' )) !!}
            ...
            <div class="form-group row {{ $errors->has('custName') ? 'has-error' : '' }}">
              ...
              <div class="col-md-10">{!! Form::text('custName', '', array('class' => 'form-control')) !!}</div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('partDesc', '', array('class' => 'form-control ')) !!}</div>
            </div>
            <div class="form-group row">
              {!! Form::label('partDesc', '2nd Description', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partDesc2', '', array('class' => 'form-control ')) !!}</div>
            </div>

            <div class="form-group row {{ $errors->has('partNo') ? 'has-error' : '' }}">
              {!! Form::label('partNo', 'Part Number', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partNo', '', array('class' => 'form-control')) !!}</div>
            ...
            <div class="form-group row {{ $errors->has('quantity') ? 'has-error' : '' }}">
              ...
              <div class="col-md-10">{!! Form::text('quantity','', array('class' => 'form-control')) !!}</div>
