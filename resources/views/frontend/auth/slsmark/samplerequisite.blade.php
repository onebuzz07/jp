...
@include('frontend.slsmark.includes.nav')
  ...
  <div class="row" id="app">
    ...
    <div class="col-lg-12">
            ...
            {!! Form::model($salesqad, array('route' => array('frontend.slsmark.storereq', $salesqad->id), 'method' => ' PUT', 'files'=> true)) !!}
            {!!Form::hidden('salesorder', $salesqad->Sales_Order)!!}
            {!!Form::hidden('line', $salesqad->Line)!!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('customerName', $salesqad->Name, array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('modelSRO', 'Model', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('modelSRO', '', array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('partDescSRO', 'Part Description', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partDescSRO', $salesqad->Description . ' ('.$salesqad->Description_1.')' , array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('partDesc2SRO', 'Part Description 2', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partDesc2SRO', '' , array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('partNumberSRO', 'Part Number', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partNumberSRO', $salesqad->Item_Number, array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('quantitySRO', 'Quantity', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('quantitySRO', $salesqad->Quantity_Ordered, array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('sizeSRO', 'Size', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('sizeSRO', '', array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('materialSRO', 'Material', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('materialSRO', '', array('class' => 'form-control')) !!}</div>
            </div>
