  ...
  @include('frontend.slsmark.includes.nav')
    <div class="col-md-12">
      {{-- @include('frontend.slsmark.includes.navindex') --}}
        ...
        {{-- <div class="col-md-6" id="button"><a class="btn btn-md btn-primary" href="{!!route('frontend.slsmark.excel')!!}">Create Reporting(For SC)</a></div>
        <br><br> --}}
  ...
  <script>
      $(function() {
          $('#users-table').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{!! route('frontend.slsmark.newsctable') !!}',
