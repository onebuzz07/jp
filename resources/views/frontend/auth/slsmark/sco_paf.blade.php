  ...
  <div class="row" id="app">
    <div class="col-lg-12">
        ...
        {!! Form::hidden('id', $sales->id) !!}
            ...
            <div class="form-group row {{ $errors->has('partDesc2') ? 'has-error' : '' }}">
              {!! Form::label('partDesc2', 'Part Description', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('partDesc2', $sales->items->partDesc2 , array('class' => 'form-control')) !!}</div>
              <span class="text-danger">{{ $errors->first('partDesc2') }}</span>
            </div>
