...
<link href="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.css" rel="stylesheet">
      <h3 class="box-title"> {!! trans('SALES CONFIRMATION') !!} <small>(For CTP department)</small> </h3>
  <div class="row" id="app">
    ...
    <div class="col-lg-12">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('deliverDate', $sales->deliverDate->format('d/m/Y'), array('class' => 'form-control', 'disabled' => 'disabled')) !!}</div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::textarea('remark', $sales->remark, array('class' => 'form-control', 'id'=>'summernote')) !!}</div>
            </div>
              <div class="form-group row">
                {!! Form::label('remark2', 'Remarks (for Planning department)', ['class' => 'col-md-2']) !!}
                <div class="col-md-10">{!! Form::textarea('remark2', $sales->remark2, array('class' => 'form-control', 'id'=>'summernote2')) !!}</div>
              </div>
              @permission('ctp')
