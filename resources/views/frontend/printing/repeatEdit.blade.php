...
<link href="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.css" rel="stylesheet">
      <h3 class="box-title"> {{ trans('REPEAT CONFIRMATION ORDER') }} <small>(For Printing department)</small> </h3>
  ...
  <div class="row" id="app">
    ...
    <div class="col-lg-12">
            {!! Form::model($repeat, array('route' => array('frontend.printing.repeatUpdate', $repeat->id), 'method' => 'PUT')) !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{{ Form::text('datetime', $repeat->datetime->format('d/m/Y'), array('class' => 'form-control', 'readonly'=>true)) }}</div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('deliverDate', $repeat->deliverDate->format('d/m/Y'), array('class' => 'form-control', 'readonly'=>true)) !!}</div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="form-group row {{ $errors->has('remark4') ? 'has-error' : '' }}">
                ...
                <div class="col-md-10">{!! Form::textarea('remark4', '', array('class' => 'form-control' , 'id'=>'4','required'=>'required')) !!}</div>
