...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-custom" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h3 class="modal-title modal-title-custom" id="exampleModalLongTitle">Flexi Die Maintenance</h3>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Flexi No</span>
                                    <input type="text" class="form-control form-control-custom-modal" id="text_mold_id_fd">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Film</span>
                    ...
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Flexi No</span>
                                    <input type="text" class="form-control form-control-custom-modal" id="text_mold_id_fd_modify">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
    ...
    <div class="container-fluid">
        <div class="panel panel-info">
            @include('frontend.printing.includes.nav', ['mainTitle' => 'Production Department / Flexi Die Maintenance'])
            <br>
    ...
    <script>
        ...
        $('#ctp-table').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                selectedMoldIdFd = table.row( this ).data().mold_id_fd;
                    ...
                    Yes: function(yesButton){
                         ...
                         $.ajax({
                            ...
                            data: { 
                                ...
                                mold_id_fd : $('#text_mold_id_fd').val(),
    ...
    <script>
        ...
        $(function(){
            $('#btnPlateModify').click(function(e){
                ...
                $("#text_mold_id_fd_modify").val(selectedMoldIdFd);
                    ...
                    Yes: function(yesButton){
                         ...
                         $.ajax({
                            ...
                            data: { 
                                ...
                                mold_id_fd : $('#text_mold_id_fd_modify').val(),
