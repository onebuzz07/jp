...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-custom" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h3 class="modal-title modal-title-custom" id="exampleModalLongTitle">Die Cut Mould Maintenance</h3>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Mould No</span>
                                    <input type="text" class="form-control form-control-custom-modal" id="text_mold_id_dc">                     
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">DieCut Machine</span>
                                    <select class="selectpicker form-control form-control-custom-modal" id="select_mac_no_dc">
                                        <option></option>
                                        @foreach ($select_mac_no_dcs as $select_mac_no_dc)
                                            <option>{{ $select_mac_no_dc->value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Stripping Board</span>
                                    <select class="form-control form-control-custom-modal" id="select_strip_board">
                                        <option></option>
                                        <option>Yes</option>
                                        <option>No</option>
                                    </select>
                    ...
                    <form>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Mould No</span>
                                    <input type="text" class="form-control form-control-custom-modal" id="text_mold_id_dc_modify">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">DieCut Machine</span>
                                    <select class="selectpicker form-control form-control-custom-modal" id="select_mac_no_dc_modify">
                                        <option></option>
                                        @foreach ($select_mac_no_dcs as $select_mac_no_dc)
                                            <option>{{ $select_mac_no_dc->value }}</option>
                                        @endforeach
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-custom-modal" id="sizing-addon2">Stripping Board</span>
                                    <select class="form-control form-control-custom-modal" id="select_strip_board_modify">
                                        <option></option>
                                        <option>Yes</option>
                                        <option>No</option>
                                    </select>
    ...
    <div class="container-fluid">
        <div class="panel panel-info">
            @include('frontend.printing.includes.nav', ['mainTitle' => 'Production Department / Die Cut Maintenance'])
            <br>
    ...
    <script>
        ...
        var selectedQtyFilm;
        var selectedRemark;
        var selectedMoldIdDc;
        var selectedMacNoDc;
        var selectedStripBoard;
    </script>
    <script>
        ...
        $('#ctp-table').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                selectedMoldIdDc = table.row( this ).data().mold_id_dc;
                selectedMacNoDc = table.row( this ).data().mac_no_dc;
                selectedStripBoard = table.row( this ).data().strip_board;
    ...
    <script>
        ...
        $(function(){
            $('#btnPlateNew').click(function(e){
                ...
                $("#text_remark").val('');
                $("#text_mold_id_dc").val('');
                $("#select_mac_no_dc").val('');
                $("#select_strip_board").val('');
                    ...
                    Yes: function(yesButton){
                         ...
                         $.ajax({
                            ...
                            data: { 
                                ...
                                mold_id_dc : $('#text_mold_id_dc').val(),
                                mac_no_dc : $('#select_mac_no_dc').val(),
                                strip_board : $('#select_strip_board').val(),
    ...
    <script>
        ...
        $(function(){
            $('#btnPlateModify').click(function(e){
                ...
                $("#text_mold_id_dc_modify").val(selectedMoldIdDc);
                $("#select_mac_no_dc_modify").val(selectedMacNoDc);
                $("#select_strip_board").val(selectedStripBoard);
                    ...
                    Yes: function(yesButton){
                         ...
                         $.ajax({
                            ...
                            data: { 
                                ...
                                mold_id_dc : $('#text_mold_id_dc_modify').val(),
                                mac_no_dc : $('#select_mac_no_dc_modify').val(),
                                strip_board : $('#select_strip_board_modify').val(),
                            },
                            success: function(result){
                                if (result.error){
                                    //alert(result.error.cust_no[0]);
