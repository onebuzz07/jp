...
<link href="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.css" rel="stylesheet">
  <h3 class="box-title"> {{ trans('VIEW PRODUCTION') }} <small>(Printing)</small> </h3>
  <div class="row" id="app">
    ...
    {!!Form::model($production, array('route' => array('frontend.production.storeprint', $production->id), 'method' => 'POST'))!!}
