...
<link href="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.css" rel="stylesheet">
      <h3 class="box-title"> {!! trans('PRODUCT AMENDMENT FORM') !!}<small>(For SRO)</small></h3>

    <div class="container-fluid">
        <div class="row" id="app">
          <div class="col-lg-12">
            <div class="col-lg-12">
              {!! Form::model($requisite, array('route' => array('frontend.slsmark.storepafsro', $requisite->id), 'method' => 'POST', 'files'=>true)) !!}
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">{!! Form::text('partNo', $requisite->partNumberSRO , array('readonly'=>true , 'class' => 'form-control ')) !!}</div>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">{!! Form::text('custName',$requisite->customerName, array('readonly'=>true , 'class' => 'form-control ')) !!}</div>
                  </div>
                  <div class="form-group row">
                    {!! Form::label('partDesc', '1st Description', ['class' => 'col-md-2']) !!}
                    <div class="col-md-10">{!! Form::text('partDesc', $requisite->partDescSRO, array('class' => 'form-control ','readonly'=>true )) !!}</div>
                  </div>
                  <div class="form-group row">
                    {!! Form::label('partDesc', '2nd Description', ['class' => 'col-md-2']) !!}
                    <div class="col-md-10">{!! Form::text('partDesc2', $requisite->partDesc2SRO, array('class' => 'form-control ','readonly'=>true)) !!}</div>
                  </div>
                </div>
              ...
              @endif
                <div class="col-md-12" >
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">{!! Form::text('revNo', null , array( 'class' => 'form-control ')) !!}</div>
                    {{-- <p> To Pre Print:</p> --}}
                    {!! Form::label('lot', 'Lot No:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('lot', '' , array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('lotcheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('mfgDate', 'MFG Date:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('mfgDate', '' , array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('mfgcheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('expiryDate', 'Expiry Date:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('expiryDate', null , array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('expcheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('dateFacNo', 'Date & Fact No:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('dateFacNo', null , array( 'class' => 'form-control')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('datecheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('packerID', 'Packer\'s ID:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('packerID', null, array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('packcheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('rawMaterial', 'Using:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('rawMaterial', '' , array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('rawcheck', 1, null, ['class' => 'field']) !!} N/A</div>

                    {!! Form::label('batchbar', 'Batch/Bar :', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('batchbar', '' , array( 'class' => 'form-control ')) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('batchcheck', 1, null,  array( 'class' => 'field ')) !!} N/A</div>
