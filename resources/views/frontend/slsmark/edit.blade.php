              ...
              <div class="col-lg-12">
                ...
                <div class="form-group row ">
                  ...
                  <div class="form-group row ">
                    ...
                    <div class="col-md-10">{!! Form::checkbox('approval', 1, null, array('readonly'=>true,'class' => 'field')) !!}</div>
                  </div>
                ...
                @else
                  <div class="col-md-12" >
                    <div class="form-group row">
                      {!! Form::label('revNo', 'Rev no:', array('class' => 'col-md-2')) !!}
                      <div class="col-md-9">{!! Form::text('sco_number', $sales->sco_number , array( 'class' => 'form-control ','disabled'=>'disabled')) !!}</div>
                      {{-- <p> To Pre Print:</p> --}}
                      {!! Form::label('lot', 'Lot No:', array('class' => 'col-md-2')) !!}
