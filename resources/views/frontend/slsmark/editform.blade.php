            ...
            <div class="col-lg-12">
              ...
              @else
                <div class="col-md-12" >
                  <div class="form-group row">
                    {!! Form::label('revNo', 'Rev no:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('sco_number', $sales->sco_number , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    {{-- <p> To Pre Print:</p> --}}
                    {!! Form::label('lot', 'Lot No:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('lot', $sales->lot , array( 'class' => 'form-control', 'readonly'=>true,)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('lotcheck', 1, $sales->lotcheck,  array( 'class' => 'field','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('mfgDate', 'MFG Date:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('mfgDate', $sales->mfgDate , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('mfgcheck', 1, $sales->mfgcheck, array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('expiryDate', 'Expiry Date:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('expiryDate', $sales->expiryDate , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('expcheck', 1, $sales->expcheck,  array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('dateFacNo', 'Date & Fact No:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('dateFacNo', $sales->dateFacNo , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('datecheck', 1, $sales->datecheck,  array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('packerID', 'Packer\'s ID:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('packerID', $sales->packerID , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('packcheck', 1, $sales->packcheck,  array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('rawMaterial', 'Using:', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('rawMaterial', $sales->items->rawMaterial , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('rawcheck', 1,$sales->items->rawcheck,  array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>

                    {!! Form::label('batchbar', 'Batch/Bar :', array('class' => 'col-md-2')) !!}
                    <div class="col-md-9">{!! Form::text('batchbar', $sales->batchbar , array( 'class' => 'form-control ','readonly'=>true)) !!}</div>
                    <div class="col-md-1">{!! Form::checkbox('batchcheck', 1, $sales->batchcheck,  array( 'class' => 'field ','readonly'=>true)) !!} N/A</div>
