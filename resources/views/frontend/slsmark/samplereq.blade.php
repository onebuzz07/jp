...
@include('frontend.slsmark.includes.nav')
  ...
  <div class="row" id="app">
    ...
    <div class="col-lg-12">
            ...
            {!! Form::model($requisite, array('route' => array('frontend.slsmark.storereq2'), 'method' => 'POST', 'files'=> true)) !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('customerName','', array('class' => 'form-control')) !!}</div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('partDescSRO', '' , array('class' => 'form-control')) !!}</div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">{!! Form::text('partNumberSRO', '', array('class' => 'form-control')) !!}</div>
            </div>

            <div class="form-group row">
              {!! Form::label('quantitySRO', 'Quantity', ['class' => 'col-md-2']) !!}
              <div class="col-md-10">{!! Form::text('quantitySRO','', array('class' => 'form-control')) !!}</div>
            </div>
