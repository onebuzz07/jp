...
<div class="row col-md-12 " id="app">
  ...
  <div class="row col-md-5">
    <table class="table table-bordered">
        ...
        <tr>
          <td>Text 5</td>
          <td>{!! Form::text('ct5', '', array('class' => 'form-control', 'id'=>'n3012a', 'v-model'=>"n3012a", 'readonly'=>true)) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('ct5ready', '', array('class' => 'form-control', 'id'=>'n3013a', 'v-model'=>"n3013a", 'readonly'=>true)) !!}</td>
          <td>{!! Form::text('ct5waste', '', array('class' => 'form-control', 'id'=>'n3014a', 'v-model'=>"n3014a", 'readonly'=>true)) !!}</td>
        </tr>
        <tr>
          <td>Stickers</td>
...
var vm = new Vue({
        el:'#app',
        data : {
          n1 : {!!$overseaswt->covOrderC!!}, n3 : {!!$overseaswt->t2OrderC!!}, n4 : {!!$overseaswt->t3OrderC!!}, n6 : {!!$overseaswt->flexiOrderC!!},
          ...
          ma1: {!!$overseaswt->surfMake!!}, ma2: {!!$overseaswt->surfWaste!!}, ma3: {!!$overseaswt->trimMake!!}, ma4: {!!$overseaswt->trimWaste!!}, ma5: {!!$overseaswt->dieMake!!}, ma6: {!!$overseaswt->dieWaste!!},
          ma7: {!!$overseaswt->stripMake!!}, ma8: {!!$overseaswt->stripWaste!!}, ma9: {!!$overseaswt->foldMake!!}, ma10: {!!$overseaswt->foldWaste!!},
          ma11: {!!$overseaswt->sewMake!!},ma12: {!!$overseaswt->sewWaste!!},ma13: {!!$overseaswt->bindMake!!},ma14: {!!$overseaswt->bindWaste!!},
          ma15: {!!$overseaswt->threeMake!!},ma16: {!!$overseaswt->threeWaste!!},ma17: {!!$overseaswt->PackMake!!},ma18: {!!$overseaswt->packWaste!!}
          ,col1: {!!$overseaswt->colMakeFront!!},col2: {!!$overseaswt->colMakeBack!!},col3: {!!$overseaswt->colWaste!!},col6: {!!$overseaswt->colMakeFront1!!},
          col7: {!!$overseaswt->colMakeBack1!!},col8: {!!$overseaswt->colWaste1!!},col11: {!!$overseaswt->colMakeFront2!!},
          col12: {!!$overseaswt->colMakeBack2!!},col13: {!!$overseaswt->colWaste2!!},

          n3e:{!!$overseaswt->t4OrderC!!},n4e:{!!$overseaswt->t5OrderC!!}, n6e: {!!$overseaswt->flexi2OrderC!!}, n13e: {!!$overseaswt->t4UpC!!}, n14e: {!!$overseaswt->t5UpC!!}, n15e: {!!$overseaswt->stat2UpC!!}, n16e: {!!$overseaswt->flexi2UpC!!}
          , n23e:{!!$overseaswt->t4signC!!}, n24e:{!!$overseaswt->t5signC!!}, n25e: {!!$overseaswt->stat2SignC!!}, n26e:{!!$overseaswt->flexi2SignC!!}
          , n33e:{!!$overseaswt->t4FrontC!!}, n34e:{!!$overseaswt->t5FrontC!!}, n35e: {!!$overseaswt->stat2FrontC!!}, n36e:{!!$overseaswt->flexi2FrontC!!},
          n43e: {!!$overseaswt->t4BackC!!}, n44e: {!!$overseaswt->t5BackC!!}, n45e: {!!$overseaswt->stat2BackC!!}, n46e: {!!$overseaswt->flexi2BackC!!}
          , n53e:{!!$overseaswt->t4SurfC!!}, n54e:{!!$overseaswt->t5SurfC!!}, n55e: {!!$overseaswt->stat2SurfC!!}, n56e:{!!$overseaswt->flexi2SurfC!!}
          , n63e:{!!$overseaswt->t4TrimC!!}, n64e:{!!$overseaswt->t5TrimC!!}, n65e: {!!$overseaswt->stat2TrimC!!}, n66e:{!!$overseaswt->flexi2TrimC!!},
          n73e: {!!$overseaswt->t4DieC!!}, n74e: {!!$overseaswt->t5DieC!!}, n75e: {!!$overseaswt->stat2DieC!!}, n76e: {!!$overseaswt->flexi2DieC!!}
          , n83e:{!!$overseaswt->t4StripC!!}, n84e:{!!$overseaswt->t5stripC!!}, n85e: {!!$overseaswt->stat2StripC!!}, n86e:{!!$overseaswt->flexi2StripC!!}
          , n93e:{!!$overseaswt->t4FoldC!!}, n94e:{!!$overseaswt->t5FoldC!!}, n95e: {!!$overseaswt->stat2FoldC!!}, n96e:{!!$overseaswt->flexi2FoldC!!},
          n103e: {!!$overseaswt->t4SewC!!}, n104e: {!!$overseaswt->t5SewC!!}, n105e: {!!$overseaswt->stat2SewC!!}, n106e: {!!$overseaswt->flexi2SewC!!}
          , n113e:{!!$overseaswt->t4BindC!!}, n114e:{!!$overseaswt->t5BindC!!}, n115e: {!!$overseaswt->stat2BindC!!}, n116e:{!!$overseaswt->flexi2BindC!!}
          , n123e:{!!$overseaswt->t43C!!}, n124e:{!!$overseaswt->t53C!!}, n125e: {!!$overseaswt->stat23C!!}, n126e:{!!$overseaswt->flexi23C!!}, cover1:{!!$overseaswt->colMakeFrontcovback!!}
            ...
            na202: function(){
              ...
              na206: function()
                ...
                na226:function() {
                  ...
                  na226e:function() {
                    var n2026a = (parseFloat(this.n6e) / parseFloat(this.n16e) * parseFloat(this.n26e) * (parseFloat(this.ma18)/ 100));
                    return this.f1(n2026a);
                    },
                  n3000: function(){
                  ...
                  n3013e: function(){
                    if (this.n3012e == 0)
                    {
                      ...
                      var na = (parseFloat(this.n3012e) - parseFloat(this.na133e) + parseFloat(this.n3e )/ parseFloat(this.n13e));
                      var na1 = na.toString();
                      var last1=na1.substr(- 1); //Get 1 character
                      var last2 = na1.substr(-2);
                      var na11 = na1.substr(0, na1.length-2);
                  ...
                  n3013a: function(){
                    if (this.n3012a == 0)
                    {
                      ...
                      var na = (parseFloat(this.n3012a) - parseFloat(this.na134e) + parseFloat(this.n4e )/ parseFloat(this.n14e));
                      var na1 = na.toString();
                      var last1=na1.substr(- 1); //Get 1 character
                      var last2 = na1.substr(-2);
                      var na11 = na1.substr(0, na1.length-2);
                  ...
                  n3014a: function(){
                    if (this.n3012a == 0)
                    {
                      ...
                      var na = (parseFloat(this.n4e) / parseFloat(this.n14e) + parseFloat(this.n3012a));
                      var na1 = na.toString();
                      var last1=na1.substr(- 1); //Get 1 character
                      var last2 = na1.substr(-2);
                      var na11 = na1.substr(0, na1.length-2);
