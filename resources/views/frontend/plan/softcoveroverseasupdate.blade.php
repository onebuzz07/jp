...
<div class="row col-md-12 " id="app">
 {!! Form::model($overseasfb, array('route' => array('frontend.plan.softcoveroversesupdate', $overseasfb->id), 'method' => 'PUT')) !!}
 ...
 <div class="col-md-6">
   <table class="table table-bordered">
       ...
       <tr>
         <td>Flexi</td>
         <td>{!! Form::text('bwcover', $overseasfb->bwcover, array('class' => 'form-control', 'id'=>'n3003', 'v-model'=>"n3003", 'readonly'=>true)) !!}</td>
         <td>Flexi Job</td>
         <td>{!! Form::text('bwcoverready', $overseasfb->bwcoverready, array('class' => 'form-control', 'id'=>'n3004', 'v-model'=>"n3004", 'readonly'=>true)) !!}</td>
         <td>{!! Form::text('bwcoverwaste', $overseasfb->bwcoverwaste, array('class' => 'form-control', 'id'=>'n3005', 'v-model'=>"n3005", 'readonly'=>true)) !!}</td>
       </tr>
