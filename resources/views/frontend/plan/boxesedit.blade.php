...
<script>
    ...
    ({
      el:'#app',
        data : {
              n2:{!!$boxes->order2!!}, n4:{!!$boxes->order4!!}, n5:{!!$boxes->up1!!}, n7:{!!$boxes->up3!!}, n6:{!!$boxes->up2!!}, n8:{!!$boxes->up4!!}
              , n9:{!!$boxes->front1!!}, n10:{!!$boxes->front2!!}, n11: {!!$boxes->back1!!} , n12:{!!$boxes->back2!!}, n13:{!!$boxes->surf1!!},
               n14:{!!$boxes->surf2!!}, n15:{!!$boxes->trim1!!},
             ...
             , n21 : {!!$boxes->flute3!!}, n22:{!!$boxes->flute4!!}, n23:{!!$boxes->die1!!}, n24:{!!$boxes->die2!!}, n25:{!!$boxes->die3!!},
              n26:{!!$boxes->die4!!}, n27:{!!$boxes->strip1!!}, n29:{!!$boxes->strip2!!}, n30:{!!$boxes->strip3!!}
             ...
             n1e:{!!$boxes->order1e!!}, n2e:{!!$boxes->order2e!!}, n3e:{!!$boxes->order3e!!}, n4e:{!!$boxes->order4e!!},
              n5e:{!!$boxes->up1e!!},n6e:{!!$boxes->up2e!!}, n7e:{!!$boxes->up3e!!},n8e:{!!$boxes->up4e!!},
              n9e:{!!$boxes->front1e!!}, n10e:{!!$boxes->front2e!!}, n11e: {!!$boxes->back1e!!} , n12e:{!!$boxes->back2e!!}, n13e:{!!$boxes->surf3e!!},n13q:{!!$boxes->surf1e!!},
              n13w:{!!$boxes->surf3!!} ,n14e:{!!$boxes->surf4e!!}
              ,n14q:{!!$boxes->surf2e!!},n14w:{!!$boxes->surf4!!}, n15e:{!!$boxes->trim1e!!}, n16e:{!!$boxes->trim2e!!}, n17e:{!!$boxes->trim3e!!}, n18e:{!!$boxes->trim4e!!}
              , n19e:{!!$boxes->flute1e!!}, n20e:{!!$boxes->flute2e!!}
             , n21e : {!!$boxes->flute3e!!}, n22e:{!!$boxes->flute4e!!}, n23e:{!!$boxes->die1e!!}, n24e:{!!$boxes->die2e!!}, n25e:{!!$boxes->die3e!!}, n26e:{!!$boxes->die4e!!}
             , n27e:{!!$boxes->strip1e!!}, n29e:{!!$boxes->strip2e!!}, n30e:{!!$boxes->strip3e!!}, n31e:{!!$boxes->strip4e!!}, n32e:{!!$boxes->window1e!!}
             , n33e:{!!$boxes->window2e!!} , n34e:{!!$boxes->window3e!!}, n35e:{!!$boxes->window4e!!}, n36e:{!!$boxes->glue1e!!}, n37e:{!!$boxes->glue2e!!}, n38e:{!!$boxes->glue3e!!}
             , n39e:{!!$boxes->glue4e!!}
             , n200:{!!$boxes->colMakeFront!!}, n201: {!!$boxes->colMakeBack!!}, n202: {!!$boxes->colWaste!!}, n203: {!!$boxes->blaMake!!}, n204: {!!$boxes->blaWaste!!}
             , n205: {!!$boxes->surfMake!!}, n206: {!!$boxes->surfWaste!!}
             , n208 : {!!$boxes->trimMake!!}, n207 : {!!$boxes->trimWaste!!}, n209: {!!$boxes->flutemake!!}, n210: {!!$boxes->flutewaste!!}
             , n211: {!!$boxes->diemake!!}, n212: {!!$boxes->diewaste!!}, n213: {!!$boxes->stripmake!!}, n214: {!!$boxes->stripwaste!!}, n215: {!!$boxes->windowsmake!!}
             , n216: {!!$boxes->windowswaste!!}, n217: {!!$boxes->glueflutemake!!}, n218: {!!$boxes->glueflutewaste!!}, n219: {!!$boxes->gluemake!!}, n220: {!!$boxes->gluewaste!!}, n221: {!!$boxes->PackMake!!}, n222: {!!$boxes->packWaste!!}
             , some1:{!!$boxes->some1!!}, some2:{!!$boxes->some2!!}
             , some11:{!!$boxes->some11!!}, some21:{!!$boxes->some21!!}
        },
        methods: {
            f1: function(value){
                if(isNaN(value))
