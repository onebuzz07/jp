  ...
  <div class="col-md-6">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>{!! Form::number('sew1Make', '', array('class' => 'form-control', 'id'=>'ma11', 'v-model'=>"ma11")) !!}</td>
        <td>{!! Form::number('sew1Waste', '', array('class' => 'form-control','step'=>"any",  'id'=>'ma12', 'v-model'=>"ma12")) !!}</td>
      </tr>
      <tr>
        <td colspan="2">Binding</td>
        <td>{!! Form::number('sew2Make', '', array('class' => 'form-control','min'=>'0', 'id'=>'ma13', 'v-model'=>"ma13")) !!}</td>
        <td>{!! Form::number('sew2Waste', '', array('class' => 'form-control','step'=>"any", 'min'=>'0', 'id'=>'ma14', 'v-model'=>"ma14")) !!}</td>
      </tr>
      <tr>
        ...
        <div class="col-md-12">
          <div class="col-md-6">
            ...
            <table class="table table-bordered">
              ...
              <tr>
                <td colspan="2">Sewing</td>
                <td>{!! Form::number('sew1Make1', '', array('class' => 'form-control', 'id'=>'ma29', 'v-model'=>"ma29")) !!}</td>
                <td>{!! Form::number('sew1Waste1', '', array('class' => 'form-control','step'=>"any", 'id'=>'ma30', 'v-model'=>"ma30")) !!}</td>
              </tr>
              <tr>
                <td colspan="2">Binding</td>
                <td>{!! Form::number('sew2Make1', '', array('class' => 'form-control', 'id'=>'ma31', 'v-model'=>"ma31")) !!}</td>
                <td>{!! Form::number('sew2Waste1', '', array('class' => 'form-control','step'=>"any", 'id'=>'ma32', 'v-model'=>"ma32")) !!}</td>
              </tr>
              <tr>
                <td colspan="2">3 Knife Trim</td>
