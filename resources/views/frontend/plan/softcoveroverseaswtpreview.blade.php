...
<div class="row col-md-12 " id="app">
  ...
  <div class="col-md-10 col-md-offset-1">
    <table class="table table-bordered" id="users-table">
      <thead>
          <tr>
            <th>{!! Form::number('none1', $overseaswt->none1, array('class' => 'form-control', 'min'=>'0', 'id'=>'n1000a', 'v-model'=>'n1000a')) !!}</th>
          </tr>
          <tr>
            <th>1/4</th>
            <th>Color</th>
      ...
      <tbody>
        ...
        <tr>
          <td>Printing</td>
          <td>{!! Form::text('covPrintC1', $overseaswt->covPrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na131', 'v-model'=>"na131")) !!}</td>
          <td>{!! Form::text('t1PrintC1', $overseaswt->t1PrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na132', 'v-model'=>"na132")) !!}</td>
          <td>{!! Form::text('t2PrintC1', $overseaswt->t2PrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na133', 'v-model'=>"na133")) !!}</td>
          <td>{!! Form::text('t3PrintC1', $overseaswt->t3PrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na134', 'v-model'=>"na134")) !!}</td>
          <td>{!! Form::text('statPrintC1', $overseaswt->statPrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na135', 'v-model'=>"na135")) !!}</td>
          <td>{!! Form::text('flexiPrintC1', $overseaswt->flexiPrintC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na136', 'v-model'=>"na136")) !!}</td>
        </tr>
        <tr>
          <td>Surface Finishing</td>
          <td>{!! Form::text('covSurfC1', $overseaswt->covSurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na141', 'v-model'=>"na141")) !!}</td>
          <td>{!! Form::text('t1SurfC1', $overseaswt->t1SurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na142', 'v-model'=>"na142")) !!}</td>
          <td>{!! Form::text('t2SurfC1', $overseaswt->t2SurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na143', 'v-model'=>"na143")) !!}</td>
          <td>{!! Form::text('t3SurfC1', $overseaswt->t3SurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na144', 'v-model'=>"na144")) !!}</td>
          <td>{!! Form::text('statSurfC1', $overseaswt->statSurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na145', 'v-model'=>"na145")) !!}</td>
          <td>{!! Form::text('flexiSurfC1', $overseaswt->flexiSurfC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na146', 'v-model'=>"na146")) !!}</td>
        </tr>
        <tr>
          <td>Trimming/Cutting</td>
          <td>{!! Form::text('covTrimC1', $overseaswt->covTrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na151', 'v-model'=>"na151")) !!}</td>
          <td>{!! Form::text('t1TrimC1', $overseaswt->t1TrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na152', 'v-model'=>"na152")) !!}</td>
          <td>{!! Form::text('t2TrimC1', $overseaswt->t2TrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na153', 'v-model'=>"na153")) !!}</td>
          <td>{!! Form::text('t3TrimC1', $overseaswt->t3TrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na154', 'v-model'=>"na154")) !!}</td>
          <td>{!! Form::text('statTrimC1', $overseaswt->statTrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na155', 'v-model'=>"na155")) !!}</td>
          <td>{!! Form::text('flexiTrimC1', $overseaswt->flexiTrimC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na156', 'v-model'=>"na156")) !!}</td>
        </tr>
        <tr>
          <td>Diecut</td>
          <td>{!! Form::text('covDieC1', $overseaswt->covDieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na161', 'v-model'=>"na161")) !!}</td>
          <td>{!! Form::text('t1DieC1', $overseaswt->t1DieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na162', 'v-model'=>"na162")) !!}</td>
          <td>{!! Form::text('t2DieC1', $overseaswt->t2DieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na163', 'v-model'=>"na163")) !!}</td>
          <td>{!! Form::text('t3DieC1', $overseaswt->t3DieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na164', 'v-model'=>"na164")) !!}</td>
          <td>{!! Form::text('statDieC1', $overseaswt->statDieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na165', 'v-model'=>"na165")) !!}</td>
          <td>{!! Form::text('flexiDieC1', $overseaswt->flexiDieC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na166', 'v-model'=>"na166")) !!}</td>
        <tr>
          <td>Stripping</td>
          <td>{!! Form::text('covStripC1', $overseaswt->covStripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na171', 'v-model'=>"na171")) !!}</td>
          <td>{!! Form::text('t1StripC1', $overseaswt->t1StripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na172', 'v-model'=>"na172")) !!}</td>
          <td>{!! Form::text('t2StripC1', $overseaswt->t2StripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na173', 'v-model'=>"na173")) !!}</td>
          <td>{!! Form::text('t3stripC1', $overseaswt->t3stripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na174', 'v-model'=>"na174")) !!}</td>
          <td>{!! Form::text('statStripC1', $overseaswt->statStripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na175', 'v-model'=>"na175")) !!}</td>
          <td>{!! Form::text('flexiStripC1', $overseaswt->flexiStripC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na176', 'v-model'=>"na176")) !!}</td>
        </tr>
        <tr>
          <td>Folding</td>
          <td>{!! Form::text('covFoldC1', $overseaswt->covFoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na181', 'v-model'=>"na181")) !!}</td>
          <td>{!! Form::text('t1FoldC1', $overseaswt->t1FoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na182', 'v-model'=>"na182")) !!}</td>
          <td>{!! Form::text('t2FoldC1', $overseaswt->t2FoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na183', 'v-model'=>"na183")) !!}</td>
          <td>{!! Form::text('t3FoldC1', $overseaswt->t3FoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na184', 'v-model'=>"na184")) !!}</td>
          <td>{!! Form::text('statFoldC1', $overseaswt->statFoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na185', 'v-model'=>"na185")) !!}</td>
          <td>{!! Form::text('flexiFoldC1', $overseaswt->flexiFoldC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na186', 'v-model'=>"na186")) !!}</td>
        </tr>
        <tr>
          <td>Sewing</td>
          <td>{!! Form::text('covSewC1', $overseaswt->covSewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na191', 'v-model'=>"na191")) !!}</td>
          <td>{!! Form::text('t1SewC1', $overseaswt->t1SewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na192', 'v-model'=>"na192")) !!}</td>
          <td>{!! Form::text('t2SewC1', $overseaswt->t2SewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na193', 'v-model'=>"na193")) !!}</td>
          <td>{!! Form::text('t3SewC1', $overseaswt->t3SewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na194', 'v-model'=>"na194")) !!}</td>
          <td>{!! Form::text('statSewC1', $overseaswt->statSewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na195', 'v-model'=>"na195")) !!}</td>
          <td>{!! Form::text('flexiSewC1', $overseaswt->flexiSewC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na196', 'v-model'=>"na196")) !!}</td>
        </tr>
        <tr>
          <td>Binding</td>
          <td>{!! Form::text('covBindC1', $overseaswt->covBindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na201', 'v-model'=>"na201")) !!}</td>
          <td>{!! Form::text('t1BindC1', $overseaswt->t1BindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na202', 'v-model'=>"na202")) !!}</td>
          <td>{!! Form::text('t2BindC1', $overseaswt->t2BindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na203', 'v-model'=>"na203")) !!}</td>
          <td>{!! Form::text('t3BindC1', $overseaswt->t3BindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na204', 'v-model'=>"na204")) !!}</td>
          <td>{!! Form::text('statBindC1', $overseaswt->statBindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na205', 'v-model'=>"na205")) !!}</td>
          <td>{!! Form::text('flexiBindC1', $overseaswt->flexiBindC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na206', 'v-model'=>"na206")) !!}</td>
        </tr>
        <tr>
          <td>3 Knife Trim</td>
          <td>{!! Form::text('cov3C1', $overseaswt->cov3C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na211', 'v-model'=>"na211")) !!}</td>
          <td>{!! Form::text('t13C1', $overseaswt->t13C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na212', 'v-model'=>"na212")) !!}</td>
          <td>{!! Form::text('t23C1', $overseaswt->t23C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na213', 'v-model'=>"na213")) !!}</td>
          <td>{!! Form::text('t33C1', $overseaswt->t33C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na214', 'v-model'=>"na214")) !!}</td>
          <td>{!! Form::text('stat3C1', $overseaswt->stat3C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na215', 'v-model'=>"na215")) !!}</td>
          <td>{!! Form::text('flexi3C1', $overseaswt->flexi3C1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na216', 'v-model'=>"na216")) !!}</td>
        </tr><tr>
          <td>Packing</td>
          <td>{!! Form::text('covPackC1', $overseaswt->covPackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na221', 'v-model'=>"na221")) !!}</td>
          <td>{!! Form::text('t1PackC1', $overseaswt->t1PackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na222', 'v-model'=>"na222")) !!}</td>
          <td>{!! Form::text('t2PackC1', $overseaswt->t2PackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na223', 'v-model'=>"na223")) !!}</td>
          <td>{!! Form::text('t3PackC1', $overseaswt->t3PackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na224', 'v-model'=>"na224")) !!}</td>
          <td>{!! Form::text('statPackC1', $overseaswt->statPackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na225', 'v-model'=>"na225")) !!}</td>
          <td>{!! Form::text('flexiPackC1', $overseaswt->flexiPackC1, array('class' => 'form-control', 'min'=>'0', 'id'=>'na226', 'v-model'=>"na226")) !!}</td>
        </tr>
      </tbody>
    </table>
  </div>
  <div class="col-md-6">
    <table class="table table-bordered">
        ...
        <tr>
          <td>Cover</td >
          <td>{!! Form::text('ccover', $overseaswt->ccover, array('class' => 'form-control', 'id'=>'n3000', 'v-model'=>"n3000")) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('ccoverready', $overseaswt->ccoverready, array('class' => 'form-control', 'id'=>'n3001', 'v-model'=>"n3001")) !!}</td>
          <td>{!! Form::text('ccoverwaste', $overseaswt->ccoverwaste, array('class' => 'form-control', 'id'=>'n3002', 'v-model'=>"n3002")) !!}</td>

        </tr>
        <tr>
          <td>Flexi</td>
          <td>{!! Form::text('flexicover', $overseaswt->flexicover, array('class' => 'form-control', 'id'=>'n3003', 'v-model'=>"n3003")) !!}</td>
          <td>Flexi Job</td>
          <td>{!! Form::text('flexicoverready', $overseaswt->flexicoverready, array('class' => 'form-control', 'id'=>'n3004', 'v-model'=>"n3004")) !!}</td>
          <td>{!! Form::text('flexicoverwaste', $overseaswt->flexicoverwaste, array('class' => 'form-control', 'id'=>'n3005', 'v-model'=>"n3005")) !!}</td>
        </tr>

        <tr>
          <td>Text 1</td>
          <td>{!! Form::text('ct1', $overseaswt->ct1, array('class' => 'form-control', 'id'=>'n3006', 'v-model'=>"n3006")) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('ct1ready', $overseaswt->ct1ready, array('class' => 'form-control', 'id'=>'n3007', 'v-model'=>"n3007")) !!}</td>
          <td>{!! Form::text('ct1waste', $overseaswt->ct1waste, array('class' => 'form-control', 'id'=>'n3008', 'v-model'=>"n3008")) !!}</td>
        </tr>
        <tr>
          <td>Text 2</td>
          <td>{!! Form::text('ct2', $overseaswt->ct2, array('class' => 'form-control', 'id'=>'n3009', 'v-model'=>"n3009")) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('ct2ready', $overseaswt->ct2ready, array('class' => 'form-control', 'id'=>'n3010', 'v-model'=>"n3010")) !!}</td>
          <td>{!! Form::text('ct2waste', $overseaswt->ct2waste, array('class' => 'form-control', 'id'=>'n3011', 'v-model'=>"n3011")) !!}</td>
        </tr>
        <tr>
          <td>Text 3</td>
          <td>{!! Form::text('ct3', $overseaswt->ct3, array('class' => 'form-control', 'id'=>'n3012', 'v-model'=>"n3012")) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('ct3ready', $overseaswt->ct3ready, array('class' => 'form-control', 'id'=>'n3013', 'v-model'=>"n3013")) !!}</td>
          <td>{!! Form::text('ct3waste', $overseaswt->ct3waste, array('class' => 'form-control', 'id'=>'n3014', 'v-model'=>"n3014")) !!}</td>
        </tr>
        <tr>
          <td>Stickers</td>
          <td>{!! Form::text('csticker', $overseaswt->csticker, array('class' => 'form-control', 'id'=>'n3015', 'v-model'=>"n3015")) !!}</td>
          <td>Color Job</td>
          <td>{!! Form::text('cstickerready', $overseaswt->cstickerready, array('class' => 'form-control', 'id'=>'n3016', 'v-model'=>"n3016")) !!}</td>
          <td>{!! Form::text('cstickerwaste', $overseaswt->cstickerwaste, array('class' => 'form-control', 'id'=>'n3017', 'v-model'=>"n3017")) !!}</td>
        </tr>
    </table>
    <table class="table table-bordered">
      <tr>
    ...
    <div class="col-md-12">
      <div class="col-md-5">
        <table class="table table-bordered" >
          <tbody>
              <tr>
                <th>{!! Form::number('none2', $overseaswt->none2, array('class' => 'form-control', 'min'=>'0', 'id'=>'n1000b', 'v-model'=>'n1000b')) !!}</th>
              <tr>
                <th></th>
                <th>Flexi</th>
              </tr>
          ...
          <div class="col-md-5">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td>Printing</td>
                  <td>{!! Form::text('flexiPrintC3', $overseaswt->flexiPrintC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa1', 'v-model'=>"naa1")) !!}</td>
                </tr>
                <tr>
                  <td>Surface Finishing</td>
                  <td>{!! Form::text('flexiSurfC3', $overseaswt->flexiSurfC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa2', 'v-model'=>"naa2")) !!}</td>
                </tr>
                <tr>
                  <td>Trimming/Cutting</td>
                  <td>{!! Form::text('flexiTrimC3', $overseaswt->flexiTrimC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa3', 'v-model'=>"naa3")) !!}</td>
                </tr>
                <tr>
                  <td>Diecut</td>
                  <td>{!! Form::text('flexiDieC3', $overseaswt->flexiDieC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa4', 'v-model'=>"naa4")) !!}</td>
                <tr>
                  <td>Stripping</td>
                  <td>{!! Form::text('flexiStripC3', $overseaswt->flexiStripC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa5', 'v-model'=>"naa5")) !!}</td>
                </tr>
                <tr>
                  <td>Folding</td>
                  <td>{!! Form::text('flexiFoldC3', $overseaswt->flexiFoldC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa6', 'v-model'=>"naa6")) !!}</td>
                </tr>
                <tr>
                  <td>Sewing</td>
                  <td>{!! Form::text('flexiSewC3', $overseaswt->flexiSewC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa7', 'v-model'=>"naa7")) !!}</td>
                </tr>
                <tr>
                  <td>Binding</td>
                  <td>{!! Form::text('flexiBindC3', $overseaswt->flexiBindC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa8', 'v-model'=>"naa8")) !!}</td>
                </tr>
                <tr>
                  <td>3 Knife Trim</td>
                  <td>{!! Form::text('flexi3C3', $overseaswt->flexi3C3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa9', 'v-model'=>"naa9")) !!}</td>
                </tr><tr>
                  <td>Packing</td>
                  <td>{!! Form::text('flexiPackC3', $overseaswt->flexiPackC3, array('class' => 'form-control', 'min'=>'0', 'id'=>'naa10', 'v-model'=>"naa10")) !!}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="col-md-12">
          <div class="col-md-6">
            <table class="table table-bordered">
                ...
                <tr>
                  <td>Flexi</td>
                  <td>{!! Form::text('flexicover1', $overseaswt->flexicover1, array('class' => 'form-control', 'id'=>'na3003', 'v-model'=>"na3003")) !!}</td>
                  <td>Flexi Job</td>
                  <td>{!! Form::text('flexicoverready1', $overseaswt->flexicoverready1, array('class' => 'form-control', 'id'=>'na3004', 'v-model'=>"na3004")) !!}</td>
                  <td>{!! Form::text('flexicoverwaste1', $overseaswt->flexicoverwaste1, array('class' => 'form-control', 'id'=>'na3005', 'v-model'=>"na3005")) !!}</td>
                </tr>
