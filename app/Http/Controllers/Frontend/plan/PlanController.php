...
class PlanController extends Controller
{
  ...
  //  <a href="'. route('frontend.plan.planning', $sales->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-book"></i>  Planning</a>
   ...
   public function softcoverStore(Request $request , $id)
   {
     ...
     $softcover->totalqtyc = $request->input('ccoverready')+$request->input('ct1ready') + $request->input('ct2ready') + $request->input('ct3ready') + $request->input('cstickerready');
     $softcover->totalpaperc = $request->input('ccoverwaste')+$request->input('ct1waste')+$request->input('ct2waste')+$request->input('ct3waste')+$request->input('cstickerwaste');
     $softcover->totalqtyb = $request->input('bwcoverready')+$request->input('bwt1ready')+$request->input('bwt2ready')+$request->input('bwt3ready')+$request->input('bwstickerready');
     $softcover->totalpaperb = $request->input('bwcoverwaste')+$request->input('bwt1waste')+$request->input('bwt2waste')+$request->input('bwt3waste')+$request->input('bwstickerwaste');
     ...
     $wotype->paper_sup =$softcover->totalpaperc + $softcover->totalpaperb;
     $wotype->printqty = $softcover->totalqtyc+$softcover->totalqtyb ;
     $wotype->save();
   ...
   public function softcoverbwStore(Request $request , $id)
   {
     ...
     $softcoverbw->totalqtyc = $request->input('bwcoverready')+$request->input('bwt1ready')+$request->input('bwt2ready')+$request->input('bwt3ready')+$request->input('bwstickerready');
     $softcoverbw->totalpaperc = $request->input('bwcoverwaste')+$request->input('bwt1waste')+$request->input('bwt2waste')+$request->input('bwt3waste')+$request->input('bwstickerwaste');
     ...
     $wotype->paper_sup = $softcoverbw->totalpaperc;
     $wotype->printqty = $softcoverbw->totalqtyc ;
     $wotype->save();
   ...
   public function softcoveroverseawtStore(Request $request ,$id )
   {
    ...
    $overseaswt->totalqtyc = $request->input('ccoverready')+$request->input('flexicoverready')+$request->input('ct1ready')+$request->input('ct2ready')+$request->input('ct3ready')+$request->input('cstickerready');
    $overseaswt->totalpaperc = $request->input('ccoverwaste')+$request->input('flexicoverwaste')+$request->input('ct1waste')+$request->input('ct1waste')+$request->input('ct1waste')+$request->input('cstickerwaste');
    ...
    $wotype->paper_sup = $overseaswt->totalpaperc;
    $wotype->printqty = $overseaswt->totalqtyc ;
    $wotype->save();
   ...
   public function softcoveroverseasStore(Request $request ,$id )
   {
    ...
    $overseasfb->totalqtyc = $request->input('ccoverready')+$request->input('flexicoverready')+$request->input('ct1ready')+$request->input('ct2ready')+$request->input('ct3ready')+$request->input('cstickerready');
    $overseasfb->totalpaperc = $request->input('ccoverwaste')+$request->input('flexicoverwaste')+$request->input('ct1waste')+$request->input('ct1waste')+$request->input('ct1waste')+$request->input('cstickerwaste');
     ...
     $wotype->paper_sup = $overseasfb->totalpaperc;
     $wotype->printqty = $overseasfb->totalqtyc ;
     $wotype->save();
   ...
   public function listTable()
   {
    ...
    //   ->select(['sales.salesline','sales.custName', 'items.partNo', 'items.partDesc' , 'productions.id'])
    //   ->where('sales.status', '=', 'Approved')
    //   ->orwhere('sales.status', '=', 'PAF');
    //
          ...
          $rows = Excel::load($path, function($reader) {
           ...
           foreach ($rows as $row) {
             ...
             // $date = \DateTime::createFromFormat('Y-m-d H:i:s', $row[3]);
                DB::table('prodqads')->insert(
                ['wo_number'=> $row[0], 'wid'=>$row[1], 'wo_part'=>$row[2], 'due_date'=>$row[3], 'salesjob' => $row[4], 'remarks' => $row[7], 'operation'=> $row[9], 'wo_name'=> $row[11], 'machine' =>$row[12], 'desc' => $row[13] ]);
            }
        }
   ...
   public function select ($id)
   {
     ...
     return view('frontend.plan.selectformula')->with('sales', $sales)->with('workorder', $workorder);
   }
   ...
   public function deletes1($id)
   {
     ...
     $workorder = Workorder::where('id', $wotype->workorders_id)->first();
